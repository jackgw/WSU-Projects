...
{
  public:
    explicit QuadraticProbingHT( int size = 101 ) : array( nextPrime( size ) )
      { makeEmpty( ); }
	...
	// Added function, insert items of vector
	...
	// Added function, print statistics
	void PrintData()
	{
		std::cout << "Quadratic Probing (Full-Length Hash):\nCollisions: " << this->CollisionsQuadraticProbingHT << "\nTotal Insertion Time (ms): "
